...
public class PlaceBlockMission extends Mission {
    ...
    public PlaceBlockMission(MissionType type, String name, int id, int blocks, ItemStack block, int exp, TypeQuest typeQuest, List<String> description, boolean isPremium) {
